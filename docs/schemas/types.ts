...
export type PresenceJoinEvent = EventEnvelope<PresenceJoinPayload> & { type: "presence.join" };
export type PresenceLeaveEvent = EventEnvelope<PresenceLeavePayload> & { type: "presence.leave" };
export type ProximityEnterEvent = EventEnvelope<ProximityEnterPayload> & { type: "proximity.enter" };
export type ProximityExitEvent = EventEnvelope<ProximityExitPayload> & { type: "proximity.exit" };
export type ChatMessageEvent = EventEnvelope<ChatMessagePayload> & { type: "chat.message" };
export type ObjectStateChangedEvent = EventEnvelope<ObjectStateChangedPayload> & { type: "object.state_changed" };
