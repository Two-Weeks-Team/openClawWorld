...
const COLOR_RANGES: ColorRange[] = [
  ...
  { r: [200, 230], g: [180, 210], b: [150, 180], type: 'floor_meeting', collision: false },
  { r: [180, 210], g: [190, 220], b: [200, 230], type: 'floor_lobby', collision: false },
  { r: [170, 200], g: [200, 230], b: [210, 240], type: 'floor_office', collision: false },
  { r: [140, 170], g: [140, 170], b: [140, 170], type: 'floor_arcade', collision: false },
  { r: [150, 180], g: [150, 180], b: [150, 180], type: 'floor_plaza', collision: false },
  { r: [190, 220], g: [200, 230], b: [190, 220], type: 'floor_lounge', collision: false },
];

const ZONE_FLOOR_TYPES: Map<TileType, ZoneId> = new Map([
  ['floor_lobby', 'lobby'],
  ['floor_office', 'office'],
  ['floor_meeting', 'meeting-center'],
