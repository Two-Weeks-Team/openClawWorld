  ...
  components: {
    ...
    schemas: {
      ...
      SkillInstallResponseData: {
        type: 'object',
        required: ['txId', 'applied', 'serverTsMs', 'skillState'],
        properties: {
          txId: { $ref: '#/components/schemas/IdTx' },
          applied: { type: 'boolean' },
          serverTsMs: { $ref: '#/components/schemas/TsMs' },
          skillState: { $ref: '#/components/schemas/AgentSkillState' },
        },
      },
    ...
    '/skill/install': {
      post: {
        ...
        responses: {
          ...
          '400': { description: 'Invalid skill ID or already installed' },
          '401': { description: 'Unauthorized' },
    ...
    '/skill/invoke': {
      post: {
        ...
        responses: {
          ...
          '400': { description: 'Invalid action or skill not installed' },
          '401': { description: 'Unauthorized' },
          '429': { description: 'Rate limited or on cooldown' },
        },
      },
    },
  },
