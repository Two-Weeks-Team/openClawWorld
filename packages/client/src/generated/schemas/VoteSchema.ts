...
export class VoteSchema extends Schema {
    ...
    @type({ map: VoteOptionSchema }) public options: MapSchema<VoteOptionSchema> = new MapSchema<VoteOptionSchema>();
    @type({ map: VoteCastSchema }) public casts: MapSchema<VoteCastSchema> = new MapSchema<VoteCastSchema>();
