...
export class EntitySchema extends Schema {
  ...
  @type({ map: SkillStateSchema }) public skillStates: MapSchema<SkillStateSchema> =
    new MapSchema<SkillStateSchema>();
  @type({ map: ActiveEffectSchema }) public activeEffects: MapSchema<ActiveEffectSchema> =
